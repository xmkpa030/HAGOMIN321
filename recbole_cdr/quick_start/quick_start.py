...
def init_logger(config):
    ...
    logfilename = '{}/{}-{}.log'.format(config['model'], config['model'], config['dataset']["target_domain"])
...
def run_recbole_cdr(model=None, config_file_list=None, config_dict=None, saved=True, gpu_id=None,):
    ...
    config = CDRConfig(model=model, config_file_list=config_file_list, config_dict=config_dict, gpu_id=gpu_id)
